...
public final class Object3DBuilder {
	...
	static {
		System.setProperty("java.protocol.handler.pkgs", "org.andresoviedo.org.andresoviedo.app.util.url|"+ System.getProperty("java.protocol.handler.pkgs"));
	...
	public static Object3DData buildFaceNormals(Object3DData obj) {
		...
		if (drawBuffer != null) {
			...
			for (int i = 0; i < vertexBuffer.capacity() / /* COORDS_PER_VERTEX */ 3 / /* VERTEX_PER_FACE */3; i++) {
				...
				// debug
				@SuppressWarnings("unused") String normal = new StringBuilder().append(normalLine[0][0]).append(",").append(normalLine[0][1])
